...
// retrieve all customers on a GET http://localhost:3000/customers request
app.get('/customers', (req, res) => {
  res.json(customers)
})

// save a new customer to the customer table on a POST http://localhost:3000/customers request
...
// updates an existing customer in the customer table on a PUT http://localhost:3000/customers/[customerId] request
...
// deletes an existing customer in the customer table on a DELETE http://localhost:3000/customers/[customerId] request
